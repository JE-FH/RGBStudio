...
export class CheckboxInputWidget extends WidgetAtom {
	...
	public get Value(): boolean {
		return this.text_input.checked;
	}

	public set Value(value: boolean) {
		this.text_input.checked = value;
		this.ValueChanged.call();
	}

	constructor(props: CheckboxInputWidgetProps) {
		...
		this.text_input.checked = props.initial_value ?? false;
