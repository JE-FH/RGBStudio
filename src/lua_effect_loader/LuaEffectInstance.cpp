...
LuaEffectInstance::LuaEffectInstance(int layer, std::shared_ptr<IKeyboardDevice> keyboard_device, TriggerObserverDispatcher& trigger_observer_dispatcher, LuaStatePtr thread)
...
LuaEffectInstance::~LuaEffectInstance()
{
	if (L != nullptr) {
...
void LuaEffectInstance::draw(double delta)
{
